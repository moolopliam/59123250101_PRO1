<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RemainKH.aspx.cs" Inherits="Khruphanth.Reports.RemainKH" %>
       ...
       <br />
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-md-2">
                    <asp:Label ID="Label3" runat="server" Text="ค้นหาตามใบเบิก"></asp:Label>
                ...
                <div class="col-md-2">
                    <asp:Label ID="Label4" runat="server" Text="ค้นหาตามผู้เบิก"></asp:Label>
                    <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource1" DataTextField="TeaName" DataValueField="TeaName"  class="form-control"></asp:DropDownList>
